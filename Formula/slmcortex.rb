class Slmcortex < Formula
  ...
  test do
    doctor_output = shell_output("#{bin}/slmcortex doctor")
    assert_match '"product_mode": "composer"', doctor_output

    composer_help = shell_output("#{bin}/slmcortex-composer --help")
    assert_match "composer-app", composer_help
  end
end
